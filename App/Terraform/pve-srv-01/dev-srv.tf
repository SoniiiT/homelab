...
resource "proxmox_vm_qemu" "dev_srv_01" {
    ...
    ipconfig0 = "ip=192.168.178.90/24,gw=192.168.178.1,ip6=dhcp"
...
resource "proxmox_vm_qemu" "dev_docker_01" {
    ...
    # (Optional) IP Address and Gateway
    ipconfig0 = "ip=192.168.178.91/24,gw=192.168.178.1,ip6=dhcp"
