...
resource "proxmox_vm_qemu" "app_srv_05" {
    ...
    # (Optional) IP Address and Gateway
    ipconfig0 = "ip=192.168.178.33/24,gw=192.168.178.1,ip6=dhcp"
...
resource "proxmox_vm_qemu" "app_srv_07" {
    ...
    # (Optional) IP Address and Gateway
    ipconfig0 = "ip=192.168.178.34/24,gw=192.168.178.1,ip6=dhcp"
...
resource "proxmox_vm_qemu" "app_srv_08" {
    ...
    # (Optional) IP Address and Gateway
    ipconfig0 = "ip=192.168.178.35/24,gw=192.168.178.1,ip6=dhcp"
